...
local nmappings      = {
  ...
  { from = 'I',          to = '$',                           mode = nvo },
  { from = '<M-u>',      to = '<up>',                        mode = ic },
  { from = '<M-e>',      to = '<down>',                      mode = ic },
  { from = '<M-n>',      to = '<left>',                      mode = ic },
  { from = '<M-i>',      to = '<right>',                     mode = ic },
  { from = '<M-U>',      to = '<cmd>normal 5u<CR>',          mode = ic },
  { from = '<M-E>',      to = '<cmd>normal 5j<CR>',          mode = ic },
  { from = '<M-N>',      to = '<cmd>normal 0<CR>',           mode = ic },
  { from = '<M-I>',      to = '<cmd>normal $<CR><right>',    mode = ic },
  { from = 'h',          to = 'e',                           mode = nv },
